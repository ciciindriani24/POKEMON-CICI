    ...
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
      <div class="px-4 pt-8">
        ...
        <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
          ...
          <p class="text-xl font-medium">Ubah Imagee</p>
        </div>
      ...
      <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
        <p class="text-xl font-medium">Informasi Umum</p>
        <p class="text-gray-400"></p>
        <div class="">
          <label for="email" class="mt-4 mb-2 block text-sm font-medium">Nomor</label>
          <div class="relative">
          ...
          <label for="card-no" class="mt-4 mb-2 block text-sm font-medium">Type</label>
          <div class="flex">
          ...
          <div class="mt-6 flex items-center justify-between">
            <p class="text-sm font-medium text-gray-900">Evolution</p>
            <p class="text-2xl font-semibold text-gray-900">Rp.{{ totalHarga() }}</p>
          </div>
        </div>
        <router-link to="/order">
          <button @click="performCheckout"
            class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Tambah</button>
            
        </router-link>
        <center> 
          <a href="" class="m-2 inline-flex items-center justify-center rounded-xl border border-transparent bg-blue-600 px-5 py-3 font-medium text-white hover:bg-blue-700"> Tambah </a>
<a href="/produk" class="m-2 inline-flex items-center justify-center rounded-xl border bg-white px-5 py-3 font-medium text-blue-600 shadow hover:bg-blue-50"> Batal </a>
